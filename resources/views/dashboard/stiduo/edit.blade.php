...
<div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('stiduoes.update', $images->id)}}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        {{ method_field('put') }}
                        ...
                        <div class="form-group">
                            <img src="{{ asset($images->image) }}" style="width: 100px" class="img-thumbnail image-preview" alt="">
                        </div>
