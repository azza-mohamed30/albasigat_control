...
<body class="hold-transition login-page" style="background-size: 50%; background-image: url('{{ asset('admin/imgs/logoo.png') }}')">
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b> مؤسسة امنة الوقفية </b></a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
